...
class GooglePayServices {
    ...
    *
        ...
        if ($getCallResponse["code"] == 200) {  // Id resource exists for this issuer account
            ...
            if ($idType == "object") {
                ...
                if ($classIdOfObjectId != $checkClassId && $checkClassId != NULL) {
                    ...
                    //throw new Exception(sprintf(">>>> Exception:\nthe classId of inserted object is (%s). " .                            "It does not match the target classId (%s). The saved object will not " .                            "have the class properties you expect.", $classIdOfObjectId, $checkClassId));
                }
            }
     ...
     *
     *  @param string getCallResponse - response from a get call
     *  @param String idType - identifier of type of get call.  "object" or "class"
     *  @param String id - unique identifier of Pass for given idType
     *  @param String checkClassId - optional. ClassId to check for if objectId exists, and idType == 'object'
     ...
     *
     *******************************/
    public function handleInsertCallStatusCode($insertCallResponse, $idType, $id, $checkClassId, $verticalType) {
     ...
     *
     *  @param int $verticalType - define type of pass being generated
     ...
     *
     *******************************/
	public function makeFatJwt($verticalType, $classId, $objectId, array $ticketData = []): ?string {
        ...
        try {
            ...
            if ($verticalType == VerticalType::OFFER) {
                ...
                $classResourcePayload = GooglePayResourceDefinitions::makeEventTicketClassResource($classId, $ticketData);
                $objectResourcePayload = GooglePayResourceDefinitions::makeEventTicketObjectResource($classId, $objectId, $ticketData);
            ...
            $googlePassJwt = new GooglePayJwt();
     ...
     *
     *******************************/
    public function makeObjectJwt($verticalType, $classId, $objectId, $ticketData = []) {
        $signedJwt = NULL;
        $classResourcePayload = NULL;
        $objectResourcePayload = NULL;
        $classResponse = NULL;
    ...
    *
    ...
    public function makeSkinnyJwt($verticalType, $classId, $objectId, array $ticketData = []) {
